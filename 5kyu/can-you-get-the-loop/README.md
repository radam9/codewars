...
| Rank:      | 5 kyu                       |
| URL:       | [https://www.codewars.com/kata/52a89c2ea8ddc5547a000863](https://www.codewars.com/kata/52a89c2ea8ddc5547a000863)                 |
| Languages: |  `ruby`  `javascript`  `python`  `java`  `haskell`  `csharp`  `php`  `kotlin`  `cpp`  `c`  |
